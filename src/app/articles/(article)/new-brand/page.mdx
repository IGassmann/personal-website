...
export const article = {
  ...
  tags: ['branding', 'technology', 'content-creation'],
};
...
[posts page](https://github.com/IGassmann/personal-website/blob/0c66e1d164efac2df32508ec33312e3cfa28fb3d/src/pages/post/%5BpostSlug%5D.js).
