...
import omwaCommonUsageImage from './omwa-common-usage.png';
import omwaTechnologiesImage from './omwa-technologies.png';
import omwaThumbnailGestionAttributionsImage from './omwa-thumbnail-gestion-attributions.png';
...
<Image src={omwaCommonUsageImage} alt="Web app’s common usage" />
...
<Image src={omwaThumbnailGestionAttributionsImage} alt="Work place assignment page" />
...
[Exploring Design Patterns with Java EE](/articles/design-patterns-java-ee) post.
...
<Image src={omwaTechnologiesImage} alt="Technologies used in the project" />
