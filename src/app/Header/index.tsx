...
function ProfilePictureContainer({ className, ...props }: React.ComponentPropsWithoutRef<'div'>) {
  return (
    <div
      className={twMerge(
        className,
...
export function Header() {
  ...
  const profilePictureRef = useRef<React.ElementRef<'div'>>(null);
  const isInitial = useRef(true);

  useEffect(() => {
    const downDelay = profilePictureRef.current?.offsetTop ?? 0;
    const upDelay = 64;
    ...
    function updateHeaderStyles() {
      ...
      if (top === 0 && scrollY > 0 && scrollY >= downDelay) {
        ...
        removeProperty('--profile-picture-top');
      } else {
        removeProperty('--header-inner-position');
        setProperty('--header-top', '0px');
        setProperty('--profile-picture-top', '0px');
      }
    }

    function updateProfilePictureStyles() {
      if (!isHomePage) {
        return;
      }
      ...
      setProperty(
        '--profile-picture-image-transform',
      ...
      setProperty('--profile-picture-border-transform', borderTransform);
      setProperty('--profile-picture-border-opacity', scale === toScale ? '1' : '0');
    }
      ...
      >
        {isHomePage ? (
          <>
            ...
            >
              <div
                className="top-[var(--profile-picture-top,theme(spacing.3))] w-full"
                style={{
              ...
              >
                <div className="relative">
                  <ProfilePictureContainer
                    ...
                    style={{
                      opacity: 'var(--profile-picture-border-opacity, 0)',
                      transform: 'var(--profile-picture-border-transform)',
                    }}
                  />
                  <ProfilePicture
                    large
                    className="block h-16 w-16 origin-left"
                    style={{ transform: 'var(--profile-picture-image-transform)' }}
                  />
                </div>
              </div>
            </Container>
