...
export const article = {
  ...
  description: '5 steps to quickly improve the performance of your pages.',
  tags: ['technology', 'web', 'performance'],
};
...
use the
[object-fit property](https://web.archive.org/web/20240920185834/https://webflow.com/updates/object-fit-support)
to reproduce the background behavior.
...
[Webflow lazy load new images by default](https://web.archive.org/web/20240520151336/https://webflow.com/updates/new-images-set-to-lazy-load-by-default),
...
- Remove unused
  ...
  and
  [interactions](https://web.archive.org/web/20240519195147/https://webflow.com/updates/clean-up-unused-interactions)
- Optimize fonts
